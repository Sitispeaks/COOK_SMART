...
public class AlertRemoveIngredientsAdapter extends RecyclerView.Adapter<AlertRemoveIngredientsAdapter.ViewHolder> {
    ...
    public AlertRemoveIngredientsAdapter(Context context, List<String> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.alert_each_ingr_design_remove, parent, false);
...
//        holder.mTextName.setText(mData.get(position).substring(0, 1).toUpperCase());
        ...
        holder.mImgRmv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mClickListener != null) mClickListener.onItemRemoveSearchClick(position);
...
//                }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            mImgRmv = itemView.findViewById(R.id.img_remve);
    ...
    public interface ItemClickListener {
        ...
        void onItemRemoveSearchClick(int position);
