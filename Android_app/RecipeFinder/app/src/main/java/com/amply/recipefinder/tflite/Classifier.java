...
package com.amply.recipefinder.tflite;
...
//        }
        ...
        Log.d("model_size", "Recived: " + bytesIntoHumanReadable(modelFile.length()));
        Log.d("label_size", "Recived: " + bytesIntoHumanReadable(labelFile.length()));
...
//    tfliteModel = FileUtil.loadMappedFile(activity, getModelPath());
        ...
        Log.d("downloaded_firebase", "model: " + modelFile.getAbsolutePath() + " size: " + modelFile.length());
        Log.d("downloaded_firebase", "label: " + labelFile.getAbsolutePath() + " size: " + labelFile.length());


        tflite = new Interpreter(modelFile, tfliteOptions);
        labels = readFile(labelFile);
...
//
//        }else{
//            Toast.makeText(activity, "Please download model properly", Toast.LENGTH_SHORT).show();
//        }

        //FileUtil.loadLabels(new FileInputStream(labelFile));
